package com.ourslook.zuoyeba.view.banner;
...
import com.ourslook.zuoyeba.view.WrapContentHeightViewPager;
...
public class HYViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private int MARKER = CENTER_MARKER;
    ...
    private WrapContentHeightViewPager mViewPager;//ViewPager
...
//        mViewPager = new ViewPager(mContext);
        mViewPager = new WrapContentHeightViewPager(mContext);
...
//
//        height = (int) Math.ceil((float) width * (float) 3 / 5);
