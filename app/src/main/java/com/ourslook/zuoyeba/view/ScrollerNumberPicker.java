...
public class ScrollerNumberPicker extends View{
	...
	/** 默认字体 */
	private float normalFont = 22.0f;//14
	/** 选中的时候字体 */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		normalFont = attribute.getDimension(
				R.styleable.NumberPicker_normalTextSize, 22.0f);
		...
		normalColor = attribute.getColor(
				R.styleable.NumberPicker_normalTextColor, 0xff999999);
		selectedColor = attribute.getColor(
				R.styleable.NumberPicker_selecredTextColor, 0xff333333);
		lineColor = attribute.getColor(R.styleable.NumberPicker_lineCoulor,
				0xff000000);
